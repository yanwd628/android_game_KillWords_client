...
public class ScreenScaleUtil {
	static final float sHpWidth = 480;// 原始横屏的宽度
	static final float sHpHeight = 320;// 原始横屏的高度
	static final float whHpRatio = sHpWidth / sHpHeight;// 原始横屏的宽高比

	static final float sSpWidth = 320;// 原始竖屏的宽度
	static final float sSpHeight = 480;// 原始竖屏的高度
	static final float whSpRatio = sSpWidth / sSpHeight;// 原始竖屏的宽高比

	public static ScreenScaleResult calScale(float targetWidth, // 目标宽度
	...
	public static int[] touchFromTargetToOrigin(int x, int y,
